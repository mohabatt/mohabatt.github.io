(() => {
  ...
  var popImpl = function(just, nothing, xs) {
  ...
  var unshiftAllImpl = function(as, xs) {
      ...
      return poll(function(e) {
        return makeEvent(function(s) {
          return function __do9() {
            ...
            when2(!st)(function __do10() {
              var unsubscribe = s(sample_1(a)(once1(e)))(function(i) {
                return justNone($$void6(liftST3(flip(modify2)(ep)(flip(snoc)(i)))));
              })();
              $$void6(write2(true)(started))();
  ...
  var keepLatest$prime = function(e) {
    return makeEvent(function(s) {
      return function __do8() {
        ...
        var onPure = function(p2) {
          return discard1(justNone($$void7(liftST4(write2(pure13(unit))(cancelInner)))))(function() {
            return justMany(p2);
          });
        };
        var onPoll = function(p2) {
          return justNone(function __do9() {
            var ep = createPure();
            var c = s(sample12(p2)(ep.event))(justOne)();
            ep.push(identity8)();
  ...
  var filterablePoll = {
    ...
    partition: function(p2) {
      return function(xs) {
        var o = partitionMap2(eitherBool(p2))(xs);
        return {
          no: o.left,
          yes: o.right
        };
    ...
    return function(associations) {
      var handleEvent = function(y) {
        return function __do8() {
          ...
          return $$void8(liftST5(push(uu)(associations)))();
        };
      };
      var go2 = function(v) {
        if (v instanceof OnlyEvent) {
        ...
        return function(atts) {
          var handleAttrEvent = function(y) {
            return function __do8() {
              ...
              return $$void8(liftST5(push(uu)(unsubs)))();
            };
          };
  ...
  var cb$prime = function(k) {
    return function(v) {
      return function(e, v1) {
        return v1.setCb(toDekuElement(e), k, v);
      };
    };
  };
  var cb = /* @__PURE__ */ function() {
    var $334 = map(functorFn)(map(functorEffect)($$const(true)));
    return function($335) {
      return Cb($334($335));
    };
  }();
  var actOnLifecycleForText = function(fromPortal, lucky, associations, p2, v, txt$prime, startAnchor$prime, endAnchor$prime) {
    ...
    return runListener(oh$primehi)(associations)(p2)();
  };
  var text5 = function(p2) {
    return function(v, v1) {
      var this$prime = pureOrBust(p2);
      var those$prime = eventOrBust2(p2);
      var that$prime = pollOrBust(p2);
      var txt = v1.makeText(bind1(this$prime)(last));
      var unsubs = liftST5(newSTArray)();
      when3(!$$null(v.unsubs))($$void8(liftST5(pushAll(v.unsubs)(unsubs))))();
  ...
  var actOnLifecycleForElement = function(fromPortal, lucky, associations, p2, v, elt$prime, startAnchor$prime, endAnchor$prime) {
  ...
  var actOnLifecycleForDyn = function(fromPortal, associations, p2, v, dbStart$prime, dbEnd$prime, startAnchor$prime, endAnchor$prime) {
  ...
  var p = /* @__PURE__ */ function() {
    return elementify(Nothing.value)("p");
  }();
    ...
    return function(e) {
      return function __do8() {
        ...
        var u = subscribe(sample4(e)(ep.event))(function(aa) {
          return liftST6($$void10(write2(aa)(r)));
        })();
        ep.push(identity11)();
  ...
  var toAbortableAff = function(abortController) {
    return function(p2) {
      return makeAff(function(cb2) {
        return function __do8() {
          $$void13(thenOrCatch4(function(a) {
  ...
  var popAndPushReverse = function(arr) {
    return run2(function __do8() {
      var mutArr = thaw(arr)();
      var mlst = pop(mutArr)();
      if (mlst instanceof Nothing) {
        return mutArr;
      }
      ;
      if (mlst instanceof Just) {
        unshift(mlst.value0)(mutArr)();
        return mutArr;
      }
      ;
      throw new Error("Failed pattern match at Main (line 149, column 5 - line 153, column 20): " + [mlst.constructor.name]);
    });
  };
  var popAndPush = function(arr) {
    return run2(function __do8() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 138, column 5 - line 142, column 20): " + [mfst.constructor.name]);
    });
  };
  ...
  var interval = function(v) {
    return setInterval2(1e3)(function __do8() {
      ...
      when4(mod2(counter + 1 | 0)(30) === 0)(v.onNextClick)();
      when4(mod2(counter)(30) === 0)(v.setFadeClass("text-show"))();
      return when4(counter === 29)(v.setFadeClass("text-fade"))();
    });
  };
  ...
  var getMessages = function(v) {
    return function __do8() {
      ...
      return launchAff_(bind22(fetch3(messagesURL)({}))(function(v1) {
        return bind22(map27(read_2)(v1.json))(function(v2) {
          if (v2 instanceof Nothing) {
            return pure23(unit);
          }
          ;
          if (v2 instanceof Just) {
            return bind22(liftEffect5(shuffle(v2.value0)))(function(shuffledMessages) {
              return discard22(liftEffect5(v.setMessages(shuffledMessages)))(function() {
                var v3 = head(shuffledMessages);
                if (v3 instanceof Nothing) {
                  return pure23(unit);
                }
                ;
                if (v3 instanceof Just) {
                  return liftEffect5(v.setActiveMessage(v3.value0));
                }
                ;
                throw new Error("Failed pattern match at Main (line 66, column 9 - line 68, column 56): " + [v3.constructor.name]);
              });
            });
          }
          ;
          throw new Error("Failed pattern match at Main (line 61, column 5 - line 68, column 56): " + [v2.constructor.name]);
        });
      }))();
    };
  };
  var cardMaker = function(v) {
    return div2([klass_2("card")])([switcherFlipped(v.activeMessage)(function(v1) {
      if (v1 instanceof Nothing) {
        return text_("No message");
      }
      ;
      if (v1 instanceof Just) {
        return div_([p([klass2(v.showClass)])([text_(v1.value0.message)]), footer([klass_2("card-footer")])([button([klass_2("card-button"), click_2(function(v2) {
          return v.onPrevClick;
        })])([text_("Prev")]), button([klass_2("card-button"), click_2(function(v2) {
          return v.onNextClick;
        })])([text_("Next")]), div2([klass_2("card-signature")])([p([klass2(v.showClass)])([text_(v1.value0.name)])])]), div2([klass_2("message-count-container")])([div2([klass_2("message-count")])([switcherFlipped(v.messageNumber)(function(n) {
          return text_(show3(n + 1 | 0));
        }), text_(" / "), switcherFlipped(v.totalMessageCount)(function($132) {
          return text_(show3($132));
        })])])]);
      }
      ;
      throw new Error("Failed pattern match at Main (line 94, column 7 - line 111, column 8): " + [v1.constructor.name]);
    })]);
  };
  var main = function __do7() {
    ...
    var runInFunc = function() {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 168, column 9 - line 170, column 41): " + [mElem.constructor.name]);
    }();
    var counterRef = $$new(0)();
    var messagesRef = $$new([])();
    var messageNumberRef = $$new(0)();
    var v = useState(Nothing.value)();
    var v1 = useHot(0)();
    var v2 = useHot(0)();
    var v3 = useHot("text-show")();
    var v4 = useHot(0)();
    var setMessages = function(msgs) {
      return function __do8() {
        write(msgs)(messagesRef)();
        return v4.value1.value0(length(msgs))();
      };
    };
    var onPrevClick = function __do8() {
      modify_(popAndPushReverse)(messagesRef)();
      var messages = read(messagesRef)();
      var v5 = head(messages);
      if (v5 instanceof Nothing) {
        return unit;
      }
      ;
      if (v5 instanceof Just) {
        v.value0(new Just(v5.value0))();
        write(0)(counterRef)();
        var messageNumberVal = read(messageNumberRef)();
        var messageCount = function __do9() {
          var $133 = read(messagesRef)();
          return length($133);
        }();
        v1.value1.value0(mod2(messageNumberVal - 1 | 0)(messageCount))();
        return modify_(function(n) {
          return n - 1 | 0;
        })(messageNumberRef)();
      }
      ;
      throw new Error("Failed pattern match at Main (line 198, column 9 - line 206, column 55): " + [v5.constructor.name]);
    };
    var onNextClick = function __do8() {
      modify_(popAndPush)(messagesRef)();
      var messages = read(messagesRef)();
      var v5 = head(messages);
      if (v5 instanceof Nothing) {
        return unit;
      ...
      ;
      throw new Error("Failed pattern match at Main (line 185, column 9 - line 193, column 55): " + [v5.constructor.name]);
    };
    getMessages({
      setMessages,
      setActiveMessage: function($135) {
        return v.value0(Just.create($135));
      }
    })();
    interval({
      messagesRef,
      setCounter: v2.value1.value0,
      counterRef,
      setFadeClass: v3.value1.value0,
      onNextClick
    })();
    return runInFunc(div_([cardMaker({
      activeMessage: v.value1,
      showClass: v3.value1.value1,
      onNextClick,
      onPrevClick,
      totalMessageCount: v4.value1.value1,
      messageNumber: v1.value1.value1
    })]))();
  };
